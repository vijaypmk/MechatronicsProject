...
#ifndef SUB_Engage_Destroy_Wall_Hugging_SubHSM__H  // <- This should be changed to your own guard on both
#define SUB_Engage_Destroy_Wall_Hugging_SubHSM__H  //    of these lines
...
#endif /* SUB_HSM_Wall_Hugging_SubHSM_H */
