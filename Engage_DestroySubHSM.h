...
#ifndef SUB_ENGAGE_DESTROY_SUBHSM_H  // <- This should be changed to your own guard on both
#define SUB_ENGAGE_DESTROY_SUBHSM_H  //    of these lines
...
#endif /* SUB_HSM_AlignCollect_SubHSM_H */