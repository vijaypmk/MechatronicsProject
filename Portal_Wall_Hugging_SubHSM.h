...
#ifndef SUB_PORTAL_WALL_HUGGING_SUBHSM__H  // <- This should be changed to your own guard on both
#define SUB_PORTAL_WALL_HUGGING_SUBHSM__H  //    of these lines
...
#endif /* SUB_HSM_Portal_Wall_Hugging_SubHSM_H */
