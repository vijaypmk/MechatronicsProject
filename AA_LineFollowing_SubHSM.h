/*
 * File: Line_FollowingSubHSM.h
 * Author: J. Edward Carryer
 * Modified: Gabriel H Elkaim and Soja-Marie Morgens
 *
 * Line_Following file to set up a Heirarchical SubState Machine to work with the Events and
...
#ifndef SUB_AA_LineFollowing_HSM_H  // <- This should be changed to your own guard on both
#define SUB_AA_Line_Following_HSM_H  //    of these lines
...
/**
 * @Function InitLine_FollowingSubHSM(void)
...
#endif /* SUB_HSM_Line_Following_H */
