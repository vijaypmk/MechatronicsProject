 ...
 *
 * Dagobot file to set up a Heirarchical SubState Machine to work with the Events and
...
#ifndef SUB_BUMPED_HSM_H  // <- This should be changed to your own guard on both
#define SUB_BUMPED_HSM_H  //    of these lines
...
/**
 * @Function InitDagobotSubHSM(void)
