...
#ifndef SUB_ACQUIRING_AMMO_HSM_H  // <- This should be changed to your own guard on both
#define SUB_ACQUIRING_AMMO_HSM_H  //    of these lines
...
#endif /* SUB_HSM_Acquiring_Ammo_H */
